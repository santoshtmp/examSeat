...
$sql1="SELECT * FROM `studata` WHERE department LIKE '%$dep1%' AND semester LIKE $se[0]";
$sql2="SELECT * FROM `studata` WHERE department LIKE '%$dep2%' AND semester LIKE $se[1]";
...
//--------------------------count total student---------------
          $countSQL1="SELECT COUNT( stu_name) as 'stud1' FROM studata WHERE department LIKE '%$dep1%'  AND semester LIKE $sem[0] ";
          $countRES1=mysqli_query($con, $countSQL1);
          $countdep1=mysqli_fetch_array($countRES1);
          $studep1=$countdep1['stud1'];

          $countSQL2="SELECT COUNT( stu_name) as 'stud2' FROM studata WHERE department LIKE '%$dep2%'  AND semester LIKE $sem[0] ";
...
//////////////////////////////////////////////////////////////////////////////
            ...
            $insert="INSERT into seatplan (block,roomno,semester,department1,start_roll1,end_roll1,department2,start_roll2,end_roll2,subject) 
