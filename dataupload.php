...
// ----------------------excell data upload------------------------------ 
	...
	for ($row=2; $row <=$highestRow ; $row++) { 
		...
		$sql="insert into stuData(stu_name,rollno,eroll,gender,department,semester) values(' ".$rowData[0][1]." ',' ".$rowData[0][2]." ',' ".$rowData[0][3]." ',' ".$rowData[0][4]." ',' ".$rowData[0][5]." ',' ".$rowData[0][6]." ')";
